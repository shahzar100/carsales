...
const eslintConfig = [
  ...
  {
    // Allow `_`-prefixed identifiers to be unused intentionally. Common
    // pattern: destructuring to drop a field (`const { _id, ...rest } = obj`),
    // or catch clauses where the error binding isn't consumed. (Day 4 / Fix 4.3.)
    rules: {
